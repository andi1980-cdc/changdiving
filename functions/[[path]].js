...
const CSP_DIRECTIVES = [
  ...
  "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://cdn.trustindex.io https://unpkg.com https://cdn.jsdelivr.net https://www.windguru.cz",
  "style-src 'self' 'unsafe-inline' https://unpkg.com https://cdn.jsdelivr.net https://cdn.trustindex.io https://fonts.googleapis.com",
  "img-src 'self' data: https://www.google-analytics.com https://www.googletagmanager.com https://cdn.trustindex.io https://i.ytimg.com https://img.youtube.com https://unpkg.com https://*.tile.openstreetmap.org https://www.windguru.cz https://*.fbcdn.net https://*.facebook.com https://*.cdninstagram.com https://*.instagram.com",
  "font-src 'self' data: https://fonts.googleapis.com https://fonts.gstatic.com",
  "connect-src 'self' https://www.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://stats.g.doubleclick.net https://cdn.trustindex.io https://www.windguru.cz https://fonts.googleapis.com https://fonts.gstatic.com https://graph.facebook.com https://*.facebook.com https://*.instagram.com",
  "frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://www.windguru.cz https://cdn.trustindex.io",
  "child-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://www.windguru.cz https://cdn.trustindex.io",
  "manifest-src 'self'",
  "media-src 'self'",
...
const REDIRECTS_EXACT_RAW = [
  ...
  [
    "/de/faqs/faq-ausruestung-logistik-koh-chang",
  ...
  [
    "/de/faqs/in-welchen-sprachen-finden-die-tauchkurse-statt",
    "/de/faqs/faq-diving-health-safety-thailand/",
  ],

  ["/de/forms", "/de/posts/"],
  [
    "/de/fun-diving-koh-chang-schritt-fuer-schritt-2025",
  ...
  [
    "/de/notfallplan-bei-tauchunfaellen-auf-koh-chang",
    "/de/posts/straight-talk/emergency-plan/",
  ],
  [
  ...
  // URLs without language prefix (redirect to English)
  ["/getting-to-koh-chang", "/en/faqs/faq-getting-here-accommodation/"],
  ["/getting-to-koh-chang/", "/en/faqs/faq-getting-here-accommodation/"],
  [
    "/why-its-important-to-book-your-diving-adventure-in-koh-chang-in-advance",
    "/en/posts/straight-talk/book-in-advance/",
  ],
  [
    "/why-its-important-to-book-your-diving-adventure-in-koh-chang-in-advance/",
    "/en/posts/straight-talk/book-in-advance/",
  ...
  ["/certification-type/sdi/", "/en/posts/straight-talk/padi-vs-sdi-tdi/"],
  ["/certification-type/padi", "/en/posts/straight-talk/padi-vs-sdi-tdi/"],
  ["/certification-type/padi/", "/en/posts/straight-talk/padi-vs-sdi-tdi/"],
  ["/tag/sdi", "/en/posts/"],
  ["/tag/sdi/", "/en/posts/"],
  ...
  [
    "/en/posts/marine-life-koh-chang/nudibranchs",
    "/en/posts/marine-life-koh-chang/marine-life-nudibranch/",
  ],
  ...
  [
    "/th/blacktip-reef-sharks-koh-chang",
  ...
  [
    "/th/dive-courses/technical-diving",
    "/th/courses/technical-diving-courses/",
  ],
  ...
  [
    "/th/faqs/faq-diving-location-accommodation-koh-chang",
  ...
  // TH How-To Guides
  [
    "/th/how-the-open-water-and-advanced-open-water-course-package-at-chang-diving-is-conducted-step-by-step-2025-koh-chang",
  ...
  [
    "/th/how-to-scuba-review/",
    "/th/posts/diving-how-to-guides-koh-chang/how-to-scuba-review/",
  ],
  [
    "/th/how-to-scuba-review",
    "/th/posts/diving-how-to-guides-koh-chang/how-to-scuba-review/",
  ...
  [
    "/th/how-to-fun-dives/",
    "/th/posts/diving-how-to-guides-koh-chang/how-to-fun-dives/",
  ],
  [
    "/th/how-to-fun-dives",
    "/th/posts/diving-how-to-guides-koh-chang/how-to-fun-dives/",
  ...
  [
    "/th/marine-life-nudibranch/",
    "/th/posts/marine-life-koh-chang/marine-life-nudibranch/",
  ],
  [
    "/th/marine-life-green-sea-turtle",
    "/th/posts/marine-life-koh-chang/marine-life-green-sea-turtle/",
  ],
  ["/th/marine-life", "/th/posts/marine-life-koh-chang/"],
  ["/th/marine-life/", "/th/posts/marine-life-koh-chang/"],
  [
    "/th/posts/marine-life-koh-chang/nudibranchs",
    "/th/posts/marine-life-koh-chang/marine-life-nudibranch/",
  ],
  ...
  ["/th/certification-agencies/", "/th/posts/straight-talk/padi-vs-sdi-tdi/"],
  [
    "/th/about-underwater-photography",
    "/th/posts/tips-and-tricks/about-underwater-photography/",
  ],
  [
    "/th/about-underwater-photography/",
    "/th/posts/tips-and-tricks/about-underwater-photography/",
...
const FORCE_GONE_EXACT = new Set(
  [
    ...
    "/en/apeks-dst4",
    // NOTE: /en/apeks-xtx is now a redirect (to /en/equipment/), not 410
    // NOTE: /en/certification-type/sdi and /padi are now redirects (to /en/posts/straight-talk/padi-vs-sdi-tdi/), not 410
    "/en/forms",
    "/en/nationalparks-in-thailand-and-koh-chang",
    "/en/service-technician",
    "/en/the-dive-process",
    "/dive-courses/discover-scuba-diving",
    "/dive-courses/discover-scuba-diving/",
...
export async function onRequest(context) {
  ...
  if (normalizedPath === "/") {
    ...
    if (!isBot && !url.searchParams.has("noredirect")) {
      ...
      const langCookie = cookieString
        .split(";")
        .find((c) => c.trim().startsWith("user_lang="));
      if (langCookie) {
  ...
  if (
    normalizedPath.startsWith("/en/videos/") &&
    normalizedPath !== "/en/videos/"
  ) {
    const headers = ensureSecurityHeaders(
      new Headers({
  ...
  if (
    normalizedPath.startsWith("/de/videos/") &&
    normalizedPath !== "/de/videos/"
  ) {
    const headers = ensureSecurityHeaders(
      new Headers({
