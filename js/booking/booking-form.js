...
(function () {
  ...
  var I18N = {
    en: {
      ...
      yes: "Yes",
      no: "No",
      equipHead: "Dive equipment",
      equipHint:
        '<strong style="color:#c62828">Full scuba equipment</strong> is included in the price — <strong style="color:#c62828">no extra rental fee</strong>. Please pick your sizes below so we can prepare the right gear. Tick only the items you need us to provide.',
      bcd: "BCD – size",
      wetsuit: "Wetsuit – size",
      selectSize: "— select size —",
      bcdTip:
        "Choose BCD <strong>one size smaller</strong> than EU T-shirt size.",
      mask: "Mask – please provide",
      fins: "Fins – please provide",
      regulator: "Regulator – please provide",
      ...
      sidemountAir: "Air (+250 THB/tank)",
      sidemountEan: "EAN/Nitrox (+300 THB/tank)",
      sidemountNo: "No (1 tank included)",
    },
    de: {
      ...
      yes: "Ja",
      no: "Nein",
      equipHead: "Tauchausrüstung",
      equipHint:
        '<strong style="color:#c62828">Die komplette Tauchausrüstung</strong> ist im Preis enthalten — <strong style="color:#c62828">keine zusätzlichen Mietkosten</strong>. Bitte Größen wählen, damit wir die passende Ausrüstung vorbereiten können. Nur ankreuzen, was wir bereitstellen sollen.',
      bcd: "BCD – Größe",
      wetsuit: "Neoprenanzug – Größe",
      selectSize: "— Größe wählen —",
      bcdTip: "BCD <strong>eine Größe kleiner</strong> als EU-T-Shirt wählen.",
      mask: "Maske – bitte bereitstellen",
      fins: "Flossen – bitte bereitstellen",
      regulator: "Atemregler – bitte bereitstellen",
      ...
      needRental: "Bitte bereitstellen",
      ...
      extraDive: "Extra-Tauchgang (+800 THB / TG)",
      nitrox: "Nitrox (+100 THB / Flasche)",
      sidemount: "Sidemount Extra-Flaschen",
      sidemountAir: "Luft (+250 THB/Flasche)",
      sidemountEan: "EAN/Nitrox (+300 THB/Flasche)",
      sidemountNo: "Nein (1 Flasche inkl.)",
    },
    th: {
      ...
      yes: "ใช่",
      no: "ไม่",
      equipHead: "อุปกรณ์ดำน้ำ",
      equipHint:
        '<strong style="color:#c62828">อุปกรณ์ดำน้ำครบชุด</strong>รวมอยู่ในราคาแล้ว — <strong style="color:#c62828">ไม่มีค่าเช่าเพิ่มเติม</strong> กรุณาเลือกไซซ์ด้านล่าง เพื่อให้เราเตรียมอุปกรณ์ที่เหมาะสม ติ๊กเฉพาะรายการที่ต้องการให้เราจัดเตรียมให้',
      bcd: "BCD – ไซส์",
      wetsuit: "เวทสูท – ไซส์",
      selectSize: "— เลือกไซส์ —",
      bcdTip: "เลือก BCD <strong>เล็กกว่าหนึ่งไซส์</strong>จากไซส์เสื้อ EU",
      mask: "หน้ากาก – ขอให้จัดเตรียมให้",
      fins: "ตีนกบ – ขอให้จัดเตรียมให้",
      regulator: "เรกกูเลเตอร์ – ขอให้จัดเตรียมให้",
      ...
      nitrox: "Nitrox (+100 บาท/ถัง)",
      sidemount: "Sidemount ถังเพิ่ม",
      sidemountAir: "อากาศ (+250 บาท/ถัง)",
      sidemountEan: "EAN/Nitrox (+300 บาท/ถัง)",
      sidemountNo: "ไม่ (รวม 1 ถัง)",
    },
  };
