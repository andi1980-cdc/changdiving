    ...
    "tech-package": {
        "en": [
            ...
            {"q": "How much does the Tech Package cost?",
             "a": "66,990 THB. Includes 7.5 days, 12 technical dives, pool session, backmount or sidemount rig, deco stage tanks, dive computer, compass, slates, DSMBs, reels, torches, instructor, materials, lunch, drinks, and hotel pickup."},
        ...
        "de": [
            ...
            {"q": "Was kostet das Tech Package?",
             "a": "66.990 THB. Enthält 7,5 Tage, 12 Technik-Tauchgänge, Pool-Session, Backmount oder Sidemount, Deco-Stage-Flaschen, Tauchcomputer, Kompass, Slates, DSMBs, Reels, Lampen, Instructor, Materialien, Mittagessen, Getränke und Hotelabholung."},
        ...
        "th": [
            ...
            {"q": "Tech Package ราคาเท่าไหร่?",
             "a": "66,990 บาท รวม 7.5 วัน 12 tech dives เซสชันสระ backmount หรือ sidemount ถัง deco stage dive computer เข็มทิศ slates DSMBs reels ไฟฉาย ครูสอน เอกสาร อาหารกลางวัน เครื่องดื่ม และรับจากโรงแรม"},
